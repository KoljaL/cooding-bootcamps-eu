...
(function (root, factory) {
    ...
    else if (typeof exports === 'object') exports['consoleColor'] = factory();
    else root.consoleColor = factory();
})(this, function () {
    function consoleColors(namespace) {
        ...
        function print(args, method) {
            ...
            return isValid ? method.bind(window.console, '%c ' + args.join(' '), currentStyles) : method.bind(window.console, ...args);
        }
